...
- [x] **Phase 20: Innholdsforutsetninger** - Capture screenshots, measure Lighthouse scores, produce visual content plan — unblocks all visual content downstream
- [x] **Phase 21: Konfig og indeks** - Extend `projects.ts` interface, redesign `/prosjekter` index as card grid, update `ProjectTeaser` — stable data layer for case study pages
- [x] **Phase 22: Kasusstudie-sider** - Build `/prosjekter/igive` and `/prosjekter/blom-company` with shared components and GEO-optimized copy
- [x] **Phase 23: SEO/GEO-pass** - Emit `CreativeWork` + `BreadcrumbList` JSON-LD, verify sitemap coverage, validate all structured data
...
|-------|-----------|----------------|--------|-----------|
| 20. Innholdsforutsetninger | v1.4 | - | Complete | 2026-03-08 |
| 21. Konfig og indeks | v1.4 | - | Complete | 2026-03-08 |
| 22. Kasusstudie-sider | v1.4 | - | Complete | 2026-03-08 |
| 23. SEO/GEO-pass | v1.4 | - | Complete | 2026-03-08 |
