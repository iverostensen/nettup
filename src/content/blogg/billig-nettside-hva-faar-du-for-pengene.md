...
faq:
  ...
  - question: "Er gratis nettsider (Wix, WordPress.com) egnet for en bedrift?"
    answer: "Gratis planer anbefales generelt ikke for bedrifter. De inkluderer reklame, subdomener og manglende funksjonalitet som svekker profesjonalitet og troverdighet betydelig."
  - question: "Hva bør alltid være inkludert i en nettside, uansett pris?"
...
- Ha plattformens reklame synlig på din nettside
- Bruke en underdomene som `dinbedrift.wix.com` i stedet for `dinbedrift.no`
- Mangle viktige funksjoner som e-postintegrasjon, avansert SEO og egne skjemaer
- Ikke ha tilgang til analyseverktøy eller konverteringssporing
...
## Maler og byggere til noen tusenlapper

Neste nivå er betalte planer på byggeplattformer, eller enkle ferdiglagde nettsider til 2 000–8 000 kroner. Her får du:

- Ditt eget domene
- En mal tilpasset din bransje
- Grunnleggende sider som forside, om oss og kontakt
- Noe støtte i oppstartsfasen
...
## Frilansutviklere til lav pris: Risiko og muligheter
...
Mange har opplevd at de har fått levert en nettside, men at leverandøren har eid domenet. Når samarbeidet avsluttes, mister bedriften alt. Dette er ikke uvanlig i det rimelige segmentet.

For mer om hva som faktisk driver kostnadene opp eller ned, se artikkelen vår om [kostnadsfaktorer i webdesign](/blogg/kostnadsfaktorer-webdesign).

---

## De skjulte kostnadene du ikke ser i tilbudet

Den virkelige prisen på en billig nettside viser seg gjerne over tid. La oss se på et konkret eksempel.

En frisørsalong bestiller en nettside til 4 000 kroner. Det virker som en god deal. Men etter ett år ser regnskapet slik ut:

- Nettside: 4 000 kr
- Hosting (tregere server): 800 kr/år
- Domene: 200 kr/år
- SSL-sertifikat (ikke inkludert): 500 kr/år
- Oppdateringer de selv må gjøre: 3–4 timer × 500 kr = 1 500–2 000 kr
- En nettside-kræsj som ingen fixer: Tapt booking i 3 dager = 5 000–15 000 kr

Total faktisk kostnad det første året: 11 000–22 000 kroner. Og nettsiden rangerer fremdeles ikke på Google fordi den ikke ble bygget med SEO i tankene.

Dette er ikke en uvanlig historia. Det er snarere regelen enn unntaket.
...
Konkrete faktorer som påvirker SEO og som ofte mangler i billige løsninger:

- **Core Web Vitals**: Googles ytelsesmålinger. Trege sider rangerer dårligere.
- **Semantisk HTML**: Riktig kodestruktur hjelper Google forstå innholdet.
- **Metabeskrivelser og tittelkoder**: Må settes opp korrekt for hver side.
- **Mobiloptimalisering**: Over 60 % av norsk nettrafikk kommer fra mobil.
- **Strukturert data (schema markup)**: Hjelper nettstedet dukke opp med rike resultater.

Hvis du vil lære mer om hvordan synlighet påvirker inntjeningen din, les artikkelen vår om [SEO for småbedrifter](/blogg/seo-for-smabedrifter).

---

## Universell utforming: Et lovkrav mange glemmer

Fra 2023 er universell utforming av nettsider et lovkrav for norske virksomheter, hjemlet i likestillings- og diskrimineringsloven og IKT-forskriften. Nettsider skal følge WCAG 2.1-standarden på nivå AA.

Billige nettsider og ferdiglagde maler er sjelden bygget med dette i tankene. Konsekvensene kan være:

- Tilsynssaker fra Tilsynet for universell utforming av IKT
...
## Når er en billig nettside faktisk godt nok?

For å gi et rettferdig bilde: Det finnes situasjoner der en enkel, rimelig løsning er fullt tilstrekkelig.

**En billig nettside kan holde hvis:**

- Du driver en svært lokal virksomhet der alle kundene kommer via muntlig anbefaling
- Du er i en oppstartsfase og trenger bare et midlertidig visittkort på nett
- Du selger ikke noe på nettsiden og trenger kun kontaktinformasjon
- Du har tid og kompetanse til å vedlikeholde den selv

**En billig nettside er ikke nok hvis:**

- Du ønsker å bli funnet på Google av nye kunder
- Du selger produkter eller tjenester direkte fra nettsiden
- Du vil bygge tillit og posisjonere deg som en seriøs aktør
- Du trenger integrasjoner med bookingsystem, betaling eller CRM

Tenk på nettsiden som en ansatt. En dårlig ansatt som jobber gratis, koster deg likevel kunder og omdømme. En god ansatt som koster litt mer, gir avkastning mange ganger over.
...
- **Teknisk SEO**: Bygget riktig fra grunnen av
- **Universell utforming**: Lovkravene ivaretatt
- **Hastighetsoptimalisering**: Raskere sider = bedre rangering og brukeropplevelse
...
1. **Hvem eier domenet og hostingen etter levering?** (Svar: Du.)
2. **Er hosting inkludert, og hos hvem?** Norske servere er lovkrav for visse datatyper.
3. **Er GDPR-dokumentasjon inkludert?** Personvernerklæring og cookies.
4. **Hva skjer etter levering?** Er det support, og hva koster det?
5. **Kan du se tidligere arbeid?** Be om referanser og se live nettsteder.
6. **Er universell utforming nevnt i leveransen?**

Et seriøst byrå eller utvikler svarer klart på alle disse spørsmålene. Diffuse svar er et rødt flagg.

---

## Den riktige investeringen for din bedrift
...
**Er gratis nettsider (Wix, WordPress.com) egnet for en bedrift?**
Gratis planer anbefales generelt ikke for bedrifter. De inkluderer reklame, subdomener og manglende funksjonalitet som svekker profesjonalitet og troverdighet betydelig.

**Hva bør alltid være inkludert i en nettside, uansett pris?**
Eget domene, sikker hosting, SSL-sertifikat (HTTPS), grunnleggende SEO-oppsett, GDPR-dokumentasjon og mobiloptimalisering er minimumskravene for enhver seriøs bedriftsnettside.