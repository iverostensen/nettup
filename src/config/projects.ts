...
export const projects: Project[] = [
  ...
  },
  {
    ...
    testimonial: {
      quote: 'Vi hadde veldig klart for oss hvordan vi ville at det skulle se ut og føles — men ikke hvordan vi skulle få det til. Nettup tok tak i det fra dag én, stilte de rette spørsmålene og leverte noe vi faktisk er stolte av å vise frem. Det er ikke alltid sånn det går.',
