  ...
  services: {
    ...
    nettside: {
      ...
      features: [
        ...
        { id: 'booking', label: 'Booking-system', price: 6000 },
        { id: 'nyhetsbrev', label: 'Nyhetsbrev-integrasjon', price: 2000 },
        { id: 'brukerpanel', label: 'Brukerpanel / innlogging', price: 8000 },
      ],
      integrations: [
    ...
    nettbutikk: {
      sizes: [
        { id: 'small', label: '1\u201350 produkter', minPrice: 15000, maxPrice: 22000 },
        { id: 'medium', label: '51\u2013200 produkter', minPrice: 25000, maxPrice: 40000 },
        { id: 'large', label: '200+ produkter', minPrice: 42000, maxPrice: 65000 },
      ],
      features: [
        ...
        { id: 'nyhetsbrev', label: 'Nyhetsbrev-integrasjon', price: 2000 },
        { id: 'brukerpanel', label: 'Brukerkonto / innlogging', price: 5000 },
    ...
    landingsside: {
      sizes: [
        { id: 'single', label: '1 side', minPrice: 4000, maxPrice: 6000 },
        { id: 'multi', label: '2\u20133 sider', minPrice: 7000, maxPrice: 10000 },
        { id: 'extended', label: '4+ sider', minPrice: 11000, maxPrice: 16000 },
      ],
      features: [
        { id: 'kontaktskjema', label: 'Kontaktskjema', price: 1000 },
